...
history_frame = tk.Frame(root, bg = "blue")
...
historyMenu.add_command(label="Past Events", underline = 0)
historyMenu.add_command(label="Present Events", underline = 0)
historyMenu.add_command(label="Future Events", underline = 0)
menubar.add_cascade(label="History", menu=historyMenu, underline=0)
#--- TEXT BOX WIDGET ---
